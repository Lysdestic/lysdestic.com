...
export const projects = [
  {
    ...
    label: 'geo-tone',
    description:
      '<em>Geo Tone</em> is an audio sequencer made for the browser with user creativity and accessibility in mind. Built with React 18, Tone.js, and Framer Motion on the front-end and a custom back-end with Express and Node.',
  ...
  },
  {
    ...
    label: 'sprout',
    description:
      '<em>Sprout</em> makes it easy to be a proud new plant parent. Browse a list of beginner-friendly houseplants, then build your budding relationship with our plant-specific caretaking guide. Made mobile-first, desktop-responsive with JavaScript, CSS, and HTML.',
  ...
  },
  {
    ...
    description:
      'Taught from January to March 2019, <em>Beginning Maker Techniques and Technologies</em> introduced students to programming and microelectronics with Arduino, CNC laser cutting, and graphic design with Adobe Illustrator.',
